<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="StorageInfo.aspx.cs" Inherits="WPSS.StockManage.StorageInfo" EnableEventValidation="false" %>
...
<body>  
   ...
   <input id="Submit1" type="submit" value="添加仓库"  runat ="server"  onmouseover="over(this,'Submit2s')" onmouseout="out(this,'Submit2s')" class ="c19012703"   onserverclick="submit1_Click" /></div>
