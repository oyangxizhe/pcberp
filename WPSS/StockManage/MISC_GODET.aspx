<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MISC_GODET.aspx.cs" Inherits="WPSS.StockManage.MISC_GODET" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>编辑开料入库信息</title>
     ...
     <div class="c13101907" id ="Div10">
       ...
       <div class="c13110501">
           <div id="Div923" class="c13110502">
               <input id="Submit1" runat="server" class="c19012703" onmouseout="out(this,'Submit2s')" onmouseover="over(this,'Submit2s')" onserverclick="submit1_Click" type="submit" value="添加开料入库" />
           </div>
...
<span style =" margin-left :0px;"><a  href="javascript:f13100202('Text4','');">选择 </a> </span> 
 <span  style =" margin-left :0px"><asp:Label ID="Label1" runat="server" Text="" ></asp:Label></span>
   ...
   <input id="Text6" type="text"  runat ="server"  class ="c14112002"  />
   <span style =" margin-left :2px; margin-right :2px;"><a  href="javascript:f13100202('Text6','');">
         选择</a></span> 
...
<div class ="c13111602">
           <asp:GridView ID="GridView1" runat="server" 
                    ...
                    onrowdatabound="GridView1_RowDataBound" 
                        AutoGenerateColumns="False"  PageSize="15" 
                          CssClass ="c21050101" onrowdeleting="GridView1_RowDeleting"
                   >
               ...
               <HeaderStyle Width="4%" />
                 <ItemStyle Width="4%"/>
                      ...
                      <asp:TemplateField HeaderText="入库单位" Visible="false">
                <ItemTemplate >
               ...
               <HeaderStyle Width="4%" />
                ...
                <ItemTemplate >
                 <asp:TextBox ID="TextBox7" runat="server"  CssClass="c14071617"></asp:TextBox>
                 <a  href="javascript:f13100202('TextBox7','<%#Eval ("项次") %>');">选择 </a>                     
                </ItemTemplate>
               <HeaderStyle Width="7%" />
                 <ItemStyle Width="7%"/>
            </asp:TemplateField> 
             ...
             <HeaderStyle Width="5%" />
              ...
              <asp:TemplateField HeaderText="客户料号">
                <ItemTemplate >
                 <asp:TextBox ID="TextBox11" runat="server"  CssClass ="c13120501" ></asp:TextBox>                     
                </ItemTemplate>
                 <HeaderStyle Width="6%" />
                 <ItemStyle Width="6%"/>
            </asp:TemplateField> 
        ...
        <asp:GridView ID="GridView2" runat="server" 
                ...
                <ItemTemplate >
                 ...
                 <ItemStyle Width="40px"  />
                           ...
                           <asp:BoundField DataField="入库单号" HeaderText="入库单号" >
       ...
       <asp:BoundField DataField="客户料号" HeaderText="客户料号" >
            ...
            <asp:BoundField DataField="入库数量" HeaderText="入库数量" >
          ...
          function f13100202(obj, obj1) {
              ...
              if (obj == "Text5") {
                  ...
                  if (dlgResult != undefined) {
                      ...
                      document.getElementById("Text10").value = dlgResult[6];/*allow GODE count*/
                  }
              }
                  ...
                  if (dlgResult != undefined) {
                      ...
                      for (i = 1; i < tr.length; i++) {
                          if (obj1 == i) {
                              ...
                              //alert("id=" + dlgResult[0] + ",料号=" + dlgResult[1] + ",品名=" + dlgResult[2] + ",客户料号=" + dlgResult[3] + ",客户名称=" + dlgResult[4]+",规格 = " + dlgResult[6] + ", 备注 = " + dlgResult[7])
              ...
              dlgResult = window.showModalDialog("../StockManage/storageinfo.aspx", window,
                  ...
                  if (dlgResult != undefined) {
                      ...
                      for (i = 1; i < tr1.length; i++) {
                          if (obj1 == i) {
                              tr1[i].getElementsByTagName("td")[4].getElementsByTagName("input")[0].value = dlgResult[1];
                              break;
                          }
                      }
                  }
              }
              else if (obj == "TextBox7") {
                  dlgResult = window.showModalDialog("../StockManage/storage_location.aspx", window,
                   "dialogWidth:970px; dialogHeight:490px; status:0");
                  if (dlgResult != undefined) {
                      ...
                      for (i = 1; i < tr2.length; i++) {
                          if (obj1 == i) {
                              var v6 = tr2[i].getElementsByTagName("td")[6].getElementsByTagName("input")[0];
                  ...
                  dlgResult = window.showModalDialog("../stockmanage/misc_pickingt.aspx", window, "dialogWidth:970px; dialogHeight:490px; status:0");
                  if (dlgResult != undefined) {
