<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="StorageCase.aspx.cs" Inherits="WPSS.StockManage.StorageCase" EnableEventValidation="false"  %>
...
<span  class ="c13102102"><asp:Label ID="prompt" runat="server"  ForeColor="#f80707"></asp:Label></span>
             ...
             <div id="i13103001" >
               ...
               AutoGenerateColumns="False" PageSize="15" 
                   ...
                   <ItemTemplate>
         <a href ="javascript:f13100302('<%#Eval ("仓库名称") %>','<%#Eval ("批号") %>','<%#Eval ("库存数量") %>')">
                       选取</a>
                   </ItemTemplate>
