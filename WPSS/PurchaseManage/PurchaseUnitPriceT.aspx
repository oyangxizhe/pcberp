     ...
     <div class="c13101907" id ="Div10">
       ...
       <div class="c13110501">
           <div id="Div923" class="c13110502">
               <input id="Submit1" runat="server" class="c19012703" onmouseout="out(this,'Submit2s')" onmouseover="over(this,'Submit2s')" onserverclick="submit1_Click" type="submit" value="添加采购核价" />
           </div>
          ...
          function f13100202(obj) {
              if (navigator.userAgent.indexOf("Chrome") > 0) {
                  ...
                  if (obj == "Text2") {
                      ...
                      myShowModalDialog("../baseinfo/wareinfo.aspx?come=purchaseunitprice", window, 960, 480);
                    
                  }
                  else if (obj == "Text6") {
                    
                      myShowModalDialog("../PurchaseManage/Supplierinfo.aspx?come=pp", window, 960, 480);
