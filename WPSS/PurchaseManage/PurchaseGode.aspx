         ...
         <asp:DropDownList  ID="DropDownList4" runat="server"    CssClass ="c13111101 ">
           <asp:ListItem></asp:ListItem>
              <asp:ListItem Value="已付款"></asp:ListItem>
               <asp:ListItem Value="部分付款"></asp:ListItem>
             ...
             <asp:TemplateField HeaderText="入库单号">
                <ItemTemplate >
                 ...
                 <ItemStyle Width="60px"  ForeColor="#595d5a"/>
                              ...
                              <asp:BoundField DataField="付款状态" HeaderText="付款状态" >
                              <ItemStyle Width="4%" ForeColor="#595d5a" />
                                    <HeaderStyle HorizontalAlign="Center" Width="4%" />
                          </asp:BoundField>
                          
                          <asp:BoundField DataField="应付金额" HeaderText="应付金额" >
                              <ItemStyle Width="4%" ForeColor="#595d5a" />
                                    <HeaderStyle HorizontalAlign="Center" Width="4%" />
                          </asp:BoundField>
                         <asp:BoundField DataField="已付金额" HeaderText="已付金额" >
                              <ItemStyle Width="4%" ForeColor="#595d5a" />
                                    <HeaderStyle HorizontalAlign="Center" Width="4%" />
                          </asp:BoundField>
                         <asp:BoundField DataField="未付金额" HeaderText="未付金额" >
                              <ItemStyle Width="4%" ForeColor="#595d5a" />
                                    <HeaderStyle HorizontalAlign="Center" Width="4%" />
                          </asp:BoundField>
