<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="step2.aspx.cs" Inherits="WPSS.PruductTrace.step2" %>
<DOCTYPE html>
       ...
       <asp:ListItem  Selected="True"  Value ="desc">降序</asp:ListItem>
               ...
               <asp:GridView ID="GridView1" runat="server"
                  ...
                  <asp:TemplateField HeaderText="工序名称" HeaderStyle-HorizontalAlign="Left" >
                          ...
                          <a   onclick ="f12100302('<%#Eval ("stid") %>','<%#Eval ("step_name") %>')" 
                      class="c19011711" ><%#Eval ("step_name") %></a><br />
             ...
             <asp:TemplateField HeaderText="操作"  HeaderStyle-Width="110px" >
                <ItemTemplate >
                    <div style="width :107px;height:30px;float:left;">
                         ...
                         class ="c19021902" 
                              onclick="f12100302('<%#Eval ("stid") %>','<%#Eval ("step_name") %>')">选择</div>
...
<script type="text/javascript" >
    ...
    function f19012702(obj,obj1) {
        window.open("/producttrace/stept.aspx?id="+obj1+"&parent_nodeid=" + parent_nodeid + "&nodeid=" + nodeid, target = '_self');
    }
