<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="utablet.aspx.cs" Inherits="WPSS.ProductTrace.utablet" %>
    ...
    <ContentTemplate>
     ...
     <div class="c13101907" id ="Div10">
          ...
          <input id="Submit2s" type="submit" value="上一页"  runat ="server"  onmouseover="over(this,'Submit2s')"
           ...
           <input id="Submit31" type="submit" value="返回表格管理"  runat ="server"  onmouseover="over(this,'Submit2s_left')"
    ...
    <input id="Text1" type="text"  runat ="server" autocomplete="off" class ="c19022103"  /> 
     ...
     <div id="i19022210"  class="c19022003" onmouseover="over(this,'i4')"  onmouseout="out(this,'i4')" onclick ="f13100203(this)"> 
               ...
               <div style ="width:340px; Height:32px  ">
                   <div style ="float :left ;width :70px ;line-height:30px;height:30px;">参数名称：</div>
                   <div style ="float :left;width :250px;" >
                      
                        <input id="Text1" type="Text"  value='<%#Eval("wname") %>' runat ="server" autocomplete="off" class="c19022320" />
                   </div>
               </div>
...
<div id="Div1"  class="c19041305" onclick ="f13100203(this)"  > 
                ...
                <span class="c19041306" id ="Span2"> 
                              ...
                              <input id="Text29" type="Text"  value='<%#Eval("paid") %>' runat ="server" autocomplete="off" class="c19022701" /> 
               </div>
                            </ItemTemplate>
                            <HeaderStyle HorizontalAlign="Left" />
                        </asp:TemplateField>
      ...
      <script type ="text/javascript" >
          ...
          function f13100204(obj, obj1) {
              ...
              if (navigator.userAgent.indexOf("Chrome") > 0) {
                  ...
                  var url = "/producttrace/parameter2.aspx?come=xtable&index=" + obj1 + "&count=" + tr.length;
                  var dlgResult = myShowModalDialog(url, window, 1000, 500);
              }
              else {

                  var url = "/producttrace/parameter2.aspx";
                  var dlgResult = myShowModalDialog(url, window, 1000, 500);
                  if (dlgResult!= null) {
