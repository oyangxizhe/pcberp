<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="trace.aspx.cs" Inherits="WPSS.PruductTrace.trace" %>
<!DOCTYPE html>
     ...
     <div class="c13101907" id ="Div10">
       ...
       <div class ="c19030701">
         ...
         <input id="Submit1" type="submit" value="搜索"  runat ="server"  onmouseover="over(this)" 
            ...
            <input id="Submit2" type="submit" value="添加产品追溯表"  runat ="server"  onmouseover="over(this,'left_xwidth140_height30')"
               onmouseout="out(this,'left_xwidth140_height30')" class ="c19041502"   onserverclick="submit1_Click" />
               ...
               <asp:GridView ID="GridView1" runat="server"
                   ...
                   >
                    ...
                    <Columns >
                          ...
                          <asp:TemplateField HeaderText="追溯单号" HeaderStyle-HorizontalAlign="Left" >
                            <ItemTemplate >
                         ...
                         <asp:TemplateField HeaderText="料号" HeaderStyle-HorizontalAlign="Left" >
                            <ItemTemplate >
                              <div style ="height:10px;"></div>
                             <%#Eval ("CO_WAREID") %>
                                <div style ="height:10px;"></div>
                         ...
                         <asp:TemplateField HeaderText="品名" HeaderStyle-HorizontalAlign="Left" >
                            <ItemTemplate >
                              <div style ="height:10px;"></div>
                             <%#Eval ("WNAME") %>
                                <div style ="height:10px;"></div>
                ...
                <ItemTemplate >
                 ...
                 <ItemStyle   ForeColor="#595d5a"/>
                        ...
                        <asp:TemplateField>
                          <ItemTemplate>
                               <asp:Label ID="L1" Text ='<%#Eval ("trid") %>' runat ="server"   Visible ="false" ></asp:Label>
                          </ItemTemplate>
...
<script type="text/javascript" >
    ...
    function over(obj, obj1) {
        ...
        else if (obj1 == "left_xwidth140_height30") {
