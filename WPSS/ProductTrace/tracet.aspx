<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="tracet.aspx.cs" Inherits="WPSS.ProductTrace.tracet" %>
   ...
   <form id="form1" runat="server">
     ...
     <div class="c13101907" id ="Div10">
          ...
          <input id="Submit2s" type="submit" value="上一页"  runat ="server"  onmouseover="over(this,'Submit2s')"
           ...
           <input id="Submit31" type="submit" value="返回产品追溯表管理"  runat ="server"  onmouseover="over(this,'left_xwidth130_height30')"
               onmouseout="out(this,'left_xwidth130_height30')" class ="c19041502"   onserverclick="submit1_Click" />
                   <input id="Submit5" type="submit" value="添加产品追溯表"  runat ="server"  onmouseover="over(this,'left_xwidth130_height30')"
               onmouseout="out(this,'left_xwidth130_height30')" class ="c19041502"   onserverclick="submit1_Click" />
    </div>
     ...
     <input id="prompt"  type="submit" value="提示窗"  runat ="server"   visible ="false"   class ="c19011410"   onserverclick="submit1_Click" />
        ...
        <div class ="c19010701">
         <div class="c19022102" id ="Div1"> 
               追溯单号：</div> 
     <div class="c19041405" id ="Div7"  onmouseover="over(this,'i11')"    onmouseout="out(this,'i11')" onclick="f13100202(this)">
    <input id="Text1" type="text"  runat ="server" autocomplete="off"  readonly ="readonly" class ="c19041810"  /> 
         </div>
                  <div class="c19022102" id ="Div21"> 
                      </div> 
     <div class="c19041405" id ="Div23"  onmouseover="over(this,'i9')"    onmouseout="out(this,'i9')" onclick="f13100202(this)">
    &nbsp;</div>   
     <div class="c19041405" id ="Div25"  onmouseover="over(this,'i10')"    onmouseout="out(this,'i10')" onclick="f13100202(this)">
    &nbsp;</div>
           </div>
  <div class ="c19010701">
         <div class="c19022102" id ="Div5"> 
               客户名称：</div> 
     <div class="c19041405" id ="i19041601"  onmouseover="over(this,'i11')"    onmouseout="out(this,'i11')" onclick="f13100202(this)">
    <input id="Text2" type="text"  runat ="server" autocomplete="off"  readonly ="readonly" class ="c19041810"  /> 
                            <span class="c19041411" id ="Span6"> 

                                              <img id="i11" src="/image/xico/x2.png " runat="server"  class="c19041310"/>
                             </span>选择
         </div>
                  <div class="c19022102" id ="Div2"> 
                      订单号：</div> 
     <div class="c19041405" id ="i19041506"  onmouseover="over(this,'i9')"    onmouseout="out(this,'i9')" onclick="f13100202(this)">
    <input id="Text3" type="text"  runat ="server" autocomplete="off"  readonly ="readonly" class ="c19041810"  /> 
                            <span class="c19041411" id ="Span3"> 

                                              <img id="i9" src="/image/xico/x2.png " runat="server"  class="c19041310"/>
                             </span>选择
         </div>   
          <div class="c19022102" id ="Div4"> 
               ID：</div> 
     <div class="c19041405" id ="i19041701"  onmouseover="over(this,'i10')"    onmouseout="out(this,'i10')" onclick="f13100202(this)">
    <input id="Text4" type="text"  runat ="server" autocomplete="off"  readonly ="readonly" class ="c19041810"  /> 
                            <span class="c19041411" id ="Span4"> 

                                              <img id="i10" src="/image/xico/x2.png " runat="server"  class="c19041310"/>
                             </span>选择
         </div>
           </div>
          <div class ="c19010701">
         <div class="c19022102" id ="Div8"> 
               <asp:Label ID="Label3" runat="server" Text="Label"></asp:Label>
               :</div> 
     <div class="c19022101" id ="Div11">
    <input id="Text5" type="text"  runat ="server" autocomplete="off" class ="c19041811"  /> 
         </div>
                  <div class="c19022102" id ="Div12"> 
                      <asp:Label ID="Label4" runat="server" Text="Label"></asp:Label>
                      ：</div> 
     <div class="c19022101" id ="Div13">
         <input id="Text6" type="text"  runat ="server" autocomplete="off" class ="c19041811"  /></div>   
          <div class="c19022102" id ="Div14"> 
               
               <asp:Label ID="Label5" runat="server" Text="Label"></asp:Label>
               ：</div> 
     <div class="c19022101" id ="Div15">
       <input id="Text7" type="text"  runat ="server" autocomplete="off" class ="c19041811"  /></div>
           </div>
  <div class ="c19010701">
         <div class="c19022102" id ="Div3"> 
               </div> 
     <div class="c19022101" id ="Div6">
         &nbsp;</div>
                  <div class="c19022102" id ="Div17"> 
                      </div> 
     <div class="c19022101" id ="Div18">
         </div>   
          <div class="c19022102" id ="Div19"> 
               
               </div> 
     <div class="c19022101" id ="Div20">
         <input id="Submit3" type="submit" value="带出产品工艺"  runat ="server"  onmouseover="over(this,'height19_width100')"
               onmouseout="out(this,'height19_width100')" class ="c19041504"   onserverclick="submit1_Click" />
         &nbsp;</div>
           </div>
         ...
         <div class="c19011402" id ="Div63">
               ...
               <asp:GridView ID="GridView1" runat="server"
                   ...
                   ShowHeader="True" 
                         CssClass ="c19041511" BorderStyle="None" CellPadding="0" GridLines ="None" OnSelectedIndexChanged="GridView1_SelectedIndexChanged" OnRowDataBound="GridView1_RowDataBound"
                   ...
                   >
                    ...
                    <Columns >
                        ...
                        <asp:TemplateField HeaderText="工序名称" HeaderStyle-HorizontalAlign="Left" ItemStyle-Width="100px" >
                            <ItemTemplate  >
                           
                                <asp:Label ID="l2" runat ="server" Text =' <%#Eval("step_name") %>'></asp:Label>
                            </ItemTemplate>
                            <HeaderStyle HorizontalAlign="Left" />
                        </asp:TemplateField>
                           <asp:TemplateField HeaderText="表格名称" HeaderStyle-HorizontalAlign="Left" ItemStyle-Width="100px" >
                            <ItemTemplate  >
                        <asp:Label ID="l3" runat ="server" Text =' <%#Eval("utable_name") %>'></asp:Label>
                            </ItemTemplate>
                            <HeaderStyle HorizontalAlign="Left" />
                        </asp:TemplateField>
                    
                           <asp:TemplateField HeaderText="参数名称" HeaderStyle-HorizontalAlign="Left" ItemStyle-Width="200px" >
                            <ItemTemplate  >
                          <asp:Label ID="l4" runat ="server" Text =' <%#Eval("parameter_name") %>'></asp:Label>
                            </ItemTemplate>
                            <HeaderStyle HorizontalAlign="Left" />
                        </asp:TemplateField>
                           <asp:TemplateField HeaderText="参数值" HeaderStyle-HorizontalAlign="Left" ItemStyle-Width="80px" >
                            <ItemTemplate  >
                           <input id="Text1" type="Text"   value='<%#Eval("parameter") %>' runat ="server" autocomplete="off" class="c19041510" />
                            </ItemTemplate>
                            <HeaderStyle HorizontalAlign="Left" />
                        </asp:TemplateField>
                       
                          <asp:TemplateField HeaderText="单位" HeaderStyle-HorizontalAlign="Left" ItemStyle-Width="100px" >
                            <ItemTemplate  >
                           
                                <asp:Label ID="l5" runat ="server" Text =' <%#Eval("单位") %>'></asp:Label>
                            </ItemTemplate>
                            <HeaderStyle HorizontalAlign="Left" />
                        </asp:TemplateField>
                      <asp:TemplateField HeaderText="" HeaderStyle-HorizontalAlign="Left" ItemStyle-Width="100px" Visible ="false"  >
                            <ItemTemplate  >
                        <asp:Label ID="l6" runat ="server" Text =' <%#Eval("csn") %>'></asp:Label>
                            </ItemTemplate>
                            <HeaderStyle HorizontalAlign="Left" />
                        </asp:TemplateField>
        ...
        <asp:GridView ID="GridView2" runat="server"
                   ...
                   >
                    ...
                    <Columns >
                        ...
                        <asp:Label ID="l3" runat ="server" Text =' <%#Eval("utable_name") %>'></asp:Label>
                           ...
                           <asp:TemplateField HeaderText="表格文件" HeaderStyle-HorizontalAlign="Left" ItemStyle-Width="100px" >
                            <ItemTemplate  >
                        <input id="File1" type="file" name="File" runat="server"    style="width:200px; font-size:9pt"    />
                            </ItemTemplate>
                            <HeaderStyle HorizontalAlign="Left" />
                        </asp:TemplateField>
                       
                       <asp:TemplateField HeaderText="" HeaderStyle-HorizontalAlign="Left" ItemStyle-Width="100px" >
                            <ItemTemplate  >
                  <a href='<%#Eval("path") %>' target="_blank" ><%#Eval("oldfilename") %></a>
                            </ItemTemplate>
                            <HeaderStyle HorizontalAlign="Left" />
                        </asp:TemplateField>
           ...
           <asp:Panel ID="p3" runat="server"  >
            ...
            <div class ="c19010703">
                <input id="Submit6" type="submit" value="暂存"  runat ="server"  
               onmouseover="over(this,'xwidth100_height30')" onmouseout="out(this,'xwidth100_height30')" class ="c19031203"   onserverclick="submit1_Click" />
           <input id="Submit1" type="submit" value="提交"  runat ="server"  onclick="javascript:return confirm('您确定要提交该条数据吗?提交后将不能再修改')"
               onmouseover="over(this,'left_xwidth100_height30')" onmouseout="out(this,'left_xwidth100_height30')" class ="c19032301"   onserverclick="submit1_Click" />
      ...
      <script type ="text/javascript" >
          function f13100202(obj) {
              if (obj.id == "i19041601") {
                  var url = "../SellManage/Customerinfo.aspx?come=trace";//请求客户信息
              ...
              else if (obj.id == "i19041506") {
                  var url = "/SellManage/order.aspx?cuid=" + document.getElementById("cuid").value + "&come=trace";//请求订单信息
                  var dlgResult = myShowModalDialog(url, window, 1100, 500);
                  if (navigator.userAgent.indexOf("Chrome") > 0) {
                  }
                  else {
                      if (dlgResult != undefined)
              ...
              else if (obj.id == "i19041701") {
                  var url = "/SellManage/ordert2.aspx?orid=" + document.getElementById("Text3").value + "";//请求订单里产品信息
                  var dlgResult = myShowModalDialog(url, window, 1100, 500);
                  if (navigator.userAgent.indexOf("Chrome") > 0) {
                  }
                  else {
          ...
          function f13100204(obj, obj1) {
              ...
              if (navigator.userAgent.indexOf("Chrome") > 0) {
                  ...
                  var url = "/producttrace/step2.aspx?come=xtable&index=" + obj1 + "&count=" + tr.length;
                  var dlgResult = myShowModalDialog(url, window, 1000, 500);
              }
              else {

                  var url = "/producttrace/step2.aspx";
                  var dlgResult = myShowModalDialog(url, window, 1000, 500);
                  if (dlgResult != null) {
          ...
          function over(obj, obj1) {
              ...
              if (obj1 == "Submit2s") {
              ...
              else if (obj1 == "left_xwidth120_height30") {

                  obj.className = "c19041408";
              }
              else if (obj1 == "left_xwidth130_height30") {

                  obj.className = "c19041503";
              }
              else if (obj1 == "height19_width100") {

                  obj.className = "c19041505";
              }
              else if (obj1 == "add") {
                  ...
                  obj.className = "c19041406";
                  document.getElementById("i9").src = "/image/xico/x3.png";
              }
              else if (obj1 == "i10") {
                  obj.className = "c19041406";
                  document.getElementById("i10").src = "/image/xico/x3.png";
              }
              else if (obj1 == "i11") {
                  obj.className = "c19041406";
                  document.getElementById("i11").src = "/image/xico/x3.png";
              }
          ...
          function out(obj, obj1) {
              ...
              if (obj1 == "Submit2s") {
                  ...
                  obj.className = "c19041407";
              }
              else if (obj1 == "left_xwidth130_height30") {

                  obj.className = "c19041502";
              }
              else if (obj1 == "height19_width100") {

                  obj.className = "c19041504";
              }
              else if (obj1 == "add") {
                  ...
                  obj.className = "c19041405";
                  document.getElementById("i9").src = "/image/xico/x2.png";
              }
              else if (obj1 == "i10") {
                  obj.className = "c19041405";
                  document.getElementById("i10").src = "/image/xico/x2.png";
              }
              else if (obj1 == "i11") {
                  obj.className = "c19041405";
                  document.getElementById("i11").src = "/image/xico/x2.png";
              }
              //alert("obj.id=" + obj.value + "," + obj1 + "," + obj.className + ",obj2=" + obj2 + ",obj2 classname=" + obj2.className);
          }
