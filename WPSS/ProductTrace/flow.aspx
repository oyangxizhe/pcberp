<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="flow.aspx.cs" Inherits="WPSS.PruductTrace.flow" %>
<!DOCTYPE html>
...
<body>
     ...
     <div class="c13101907" id ="Div10">
       ...
       <div class ="c19030701">
         ...
         <input id="Submit1" type="submit" value="搜索"  runat ="server"  onmouseover="over(this)" 
             ...
             <input id="Submit2" type="submit" value="添加产品工艺"  runat ="server"  onmouseover="over(this,'left_xwidth100_height30')" onmouseout="out(this,'left_xwidth100_height30')" class ="c19032301" 
   ...
   <asp:TemplateField HeaderText="选取" HeaderStyle-HorizontalAlign="Left" >
                            <ItemTemplate >
                              <div style ="height:10px;"></div>
                               
                          <a   onclick ="f12100302('<%#Eval ("flid") %>','<%#Eval ("flow_name") %>')" 
                      class="c19011711" >选取</a><br />
                         
                                <div style ="height:10px;"></div>
                            </ItemTemplate>
                            <HeaderStyle HorizontalAlign="Left" />
                        </asp:TemplateField>
                          <asp:TemplateField HeaderText="工艺流程名称" HeaderStyle-HorizontalAlign="Left" >
                            <ItemTemplate >
                              <div style ="height:10px;"></div>
                             <%#Eval ("flow_name") %>
                                <div style ="height:10px;"></div>
                ...
                <ItemTemplate >
                 ...
                 <ItemStyle   ForeColor="#595d5a"/>
                        ...
                        <asp:TemplateField>
                          <ItemTemplate>
                               <asp:Label ID="L1" Text ='<%#Eval ("flid") %>' runat ="server"   Visible ="false" ></asp:Label>
                          </ItemTemplate>
...
<script type="text/javascript" >
    ...
    function f12100302(obj, obj1, obj2, obj3, obj4, obj5, obj6, obj7, obj8) {
        ...
        if (navigator.userAgent.indexOf("Chrome") > 0) {
             if(come=="wareinfo") {
                window.opener.document.getElementById("Text21").value = obj1;//调用页面在母版页中，所以ID由Text2变为ctl00_ContentPlaceHolder1_Text2
