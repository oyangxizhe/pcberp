<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="parameter.aspx.cs" Inherits="WPSS.PruductTrace.parameter" %>
<DOCTYPE html>
...
<body>
     ...
     <div class="c13101907" id ="Div10">
       ...
       <div class ="c19030701">
         ...
         <input id="Submit1" type="submit" value="搜索"  runat ="server"  onmouseover="over(this)" 
             ...
             <input id="Submit2" type="submit" value="添加参数"  runat ="server"  onmouseover="over(this,'left_xwidth100_height30')" onmouseout="out(this,'left_xwidth100_height30')" class ="c19032301" 
    ...
    <div class ="c18092614">
               ...
               <asp:GridView ID="GridView1" runat="server"
                   ...
                   >
                    ...
                    <Columns >
                          ...
                          <asp:TemplateField HeaderText="参数" HeaderStyle-HorizontalAlign="Left" >
                            <ItemTemplate >
     ...
     <asp:DropDownList  ID="DropDownList5" runat="server"  AutoPostBack="true"  OnSelectedIndexChanged="DropDownList8_SelectedIndexChanged" >
