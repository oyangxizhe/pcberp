<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="utable.aspx.cs" Inherits="WPSS.PruductTrace.utable" %>
<DOCTYPE html>
     ...
     <div class="c13101907" id ="Div10">
       ...
       <div class ="c19030701">
         ...
         <input id="Submit1" type="submit" value="搜索"  runat ="server"  onmouseover="over(this)" 
             ...
             <input id="Submit2" type="submit" value="添加表格"  runat ="server"  onmouseover="over(this,'left_xwidth100_height30')" onmouseout="out(this,'left_xwidth100_height30')" class ="c19032301" 
               ...
               <asp:GridView ID="GridView1" runat="server"
                ...
                <ItemTemplate >
                 ...
                 <ItemStyle   ForeColor="#595d5a"/>
                        ...
                        <asp:TemplateField>
                          <ItemTemplate>
                               <asp:Label ID="L1" Text ='<%#Eval ("utid") %>' runat ="server"   Visible ="false" ></asp:Label>
                          </ItemTemplate>
