<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="parameter2.aspx.cs" Inherits="WPSS.PruductTrace.parameter2" %>
<DOCTYPE html>
     ...
     <div class="c19011101" id ="Div17">
       ...
       <asp:ListItem  Selected="True"  Value ="desc">降序</asp:ListItem>
               ...
               <asp:GridView ID="GridView1" runat="server"
                  ...
                  <asp:TemplateField HeaderText="参数名称" HeaderStyle-HorizontalAlign="Left" >
                            <ItemTemplate >
                              <div style ="height:10px;"></div>
                               
                          <a   onclick ="f12100302('<%#Eval ("paid") %>','<%#Eval ("parameter_name") %>')" 
                      class="c19011711" ><%#Eval ("parameter_name") %></a><br />
              ...
              <asp:TemplateField HeaderText="操作"  HeaderStyle-Width="110px" >
                <ItemTemplate >
                    <div style="width :107px;height:30px;float:left;">
                         ...
                         class ="c19021902" 
                              onclick="f12100302('<%#Eval ("paid") %>','<%#Eval ("parameter_name") %>')">选择</div>
                     <div   id="search" onmouseover="over(this,'edit_top1')" onmouseout="out(this,'edit_top1')" style="visibility:hidden"
                          class ="c19041401" onclick ="f19012702(this,'<%#Eval ("id") %>')" >查看</div>
                        </div>
                     </ItemTemplate>
                 <HeaderStyle  HorizontalAlign ="Left" />
...
<script type="text/javascript" >
    ...
    function f19012702(obj,obj1) {
        window.open("/producttrace/parametert.aspx?id="+obj1+"&parent_nodeid=" + parent_nodeid + "&nodeid=" + nodeid, target = '_self');
    }
    function f12100302(obj, obj1) {
        ...
        if (navigator.userAgent.indexOf("Chrome") > 0) {
            ...
            for (i = 1; i <= count; i++) {
                ...
                if (index == i) {
                    if (i == 1) {
                        //alert("index=" + index + ",i=" + i + ",count1=" + tr.length);
                        window.opener.document.getElementById("GridView1_ctl02_Text29").value = arr1[0];
                        //alert("index=" + index + ",i=" + i + ",count2=" + tr.length);
    ...
    function over(obj, obj1) {
        ...
        else if (obj1 == "edit_top1") {

            obj.className = "c19041402";
        }
        else if (obj1 == "delete") {
