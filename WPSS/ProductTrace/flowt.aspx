<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="flowt.aspx.cs" Inherits="WPSS.ProductTrace.flowt" %>
...
<body >
    ...
    <ContentTemplate>
     ...
     <div class="c13101907" id ="Div10">
          ...
          <input id="Submit2s" type="submit" value="上一页"  runat ="server"  onmouseover="over(this,'Submit2s')"
           ...
           <input id="Submit31" type="submit" value="返回产品工艺管理"  runat ="server"  onmouseover="over(this,'left_xwidth120_height30')"
               onmouseout="out(this,'left_xwidth120_height30')" class ="c19041407"   onserverclick="submit1_Click" />
                        &nbsp;&nbsp;
    </div>
  ...
  <div class ="c19010701">
    ...
    <input id="Text1" type="text"  runat ="server" autocomplete="off" class ="c19022103"  /> 
     ...
     <div class="c19041405" id ="Div3"  onmouseover="over(this,'i9')"    onmouseout="out(this,'i9')" onclick="f13100202(this)">
         &nbsp;</div>   
     <div class="c19022101" id ="Div7">
         &nbsp;</div>
           </div>
          <div class ="c19010701">
     ...
     <div class="c19022101" id ="Div13">
        <input id="Text5" type="text"  runat ="server" autocomplete="off" class ="c19022103"  /></div>   
          <div class="c19022102" id ="Div14"> 
               生效否：</div> 
     <div class="c19022101" id ="Div15">
        <asp:DropDownList ID="DropDownList1" runat="server" CssClass="c19022115"    >
     ...
     <div id="i19022210"  class="c19022003" onmouseover="over(this,'i4')"  onmouseout="out(this,'i4')" onclick ="f13100203(this)"> 
               ...
               <div style ="width:500px; Height:32px  ">
                   <div style ="float :left ;width :70px ;line-height:30px;height:30px;">序号：</div>
                    <div style ="float :left;width :90px;" >
                      
                        <input id="Text2" type="Text"  value='<%#Eval("csn") %>' runat ="server" autocomplete="off" class="c19050501" />
                   </div>
                      <div style ="float :left ;width :70px ;line-height:30px;height:30px;">工序名称：</div>
                   <div style ="float :left;width :250px;" >
                      
                        <input id="Text1" type="Text"  value='<%#Eval("step_name") %>' runat ="server" autocomplete="off" class="c19022320" />
                   </div>
               </div>
                          ...
                          <asp:TemplateField HeaderText="基本信息2" HeaderStyle-HorizontalAlign="Left" ItemStyle-Width="100px" >
                            <ItemTemplate >
                          <div style ="height :32px;width:140px;float:left;">
...
<div id="Div1"  class="c19041305" onclick ="f13100203(this)"  > 
                ...
                <span class="c19041306" id ="Span2"> 
                              ...
                              <input id="Text29" type="Text"  value='<%#Eval("stid") %>' runat ="server" autocomplete="off" class="c19022701" /> 
               </div>
                            </ItemTemplate>
                            <HeaderStyle HorizontalAlign="Left" />
                        </asp:TemplateField>
      ...
      <script type ="text/javascript" >
          function f13100202(obj) {
              var url = "/BaseInfo/WareinfoP.aspx?come=flow";
