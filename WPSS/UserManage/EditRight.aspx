...
<body>  
   ...
   <input id="Submit1" type="submit" value="添加用户权限"  runat ="server"  onmouseover="over(this,'Submit2s')" onmouseout="out(this,'Submit2s')" class ="c19012703"   onserverclick="submit1_Click" /></div>
