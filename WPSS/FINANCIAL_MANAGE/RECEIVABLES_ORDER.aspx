...
<div class ="c13110501">
 <div class="c13110502" id ="Div4">
   <input id="Submit1" type="submit" value="添加收款单"  runat ="server"  onmouseover="over(this,'Submit2s')" onmouseout="out(this,'Submit2s')" class ="c19012703"   onserverclick="submit1_Click" /></div>
             ...
             <asp:TemplateField HeaderText="收款单号">
                <ItemTemplate >
                 ...
                 <ItemStyle Width="100px"  ForeColor="#595d5a"/>
                            ...
                            <asp:BoundField DataField="销货单号" HeaderText="销货单号" >
