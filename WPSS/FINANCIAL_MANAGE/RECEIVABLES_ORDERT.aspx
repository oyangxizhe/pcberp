     ...
     <div class="c13101907" id ="Div10">
       ...
       <div class="c13110501">
           <div id="Div923" class="c13110502">
               <input id="Submit1" runat="server" class="c19012703" onmouseout="out(this,'Submit2s')" onmouseover="over(this,'Submit2s')" onserverclick="submit1_Click" type="submit" value="添加收款单" />
           </div>
     ...
     <div class="c13122401" id ="Div109">
      ...
      <script type ="text/javascript" >
          ...
          function f13100202(obj, obj1) {
              ...
              if (navigator.userAgent.indexOf("Chrome") > 0) {
                  if (obj == "Text2") {
                      var url = "../financial_manage/selltable.aspx?code=0";
                      //传入参数示例
                  ...
                  if (obj == "Text2") {
                      dlgResult = window.showModalDialog("../sellmanage/selltable.aspx?code=0", window, "dialogWidth:970px; dialogHeight:490px; status:0;");
