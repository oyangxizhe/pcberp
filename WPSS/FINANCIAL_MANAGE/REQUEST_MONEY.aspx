...
<span  class ="c13102102">
             ...
             <div >
               ...
               <asp:GridView ID="GridView1" runat="server" 
                   ...
                   <ItemTemplate>
         <a href ="javascript:f13100302('<%#Eval ("应付单号") %>','<%#Eval ("供应商") %>','<%#Eval ("发票号码") %>', '<%#Eval ("发票含税") %>',
         '<%#Eval ("预付单号") %>', '<%#Eval ("预付金额") %>','<%#Eval ("扣款项目") %>','<%#Eval ("扣款金额") %>','<%#Eval ("实际应付金额") %>',
                ...
                <ItemTemplate >
                 ...
                 <ItemStyle Width="80px"  ForeColor="#595d5a"/>
                    ...
                    <ItemStyle Width="100px" ForeColor="#595d5a" />
                             ...
                             <asp:BoundField DataField="发票未税" HeaderText="发票未税" >
                             <ItemStyle Width="80px"  ForeColor="#595d5a"  HorizontalAlign="Right" />
                              ...
                              <asp:BoundField DataField="发票含税" HeaderText="发票含税" >
                              <ItemStyle Width="80px"  ForeColor="#595d5a"  HorizontalAlign="Right" />
                                    <HeaderStyle Width="80px" HorizontalAlign="Right" />
                          </asp:BoundField>
                              <asp:BoundField DataField="应付日期" HeaderText="应付款日期" >
                              <ItemStyle Width="100px" ForeColor="#595d5a" />
                                    <HeaderStyle HorizontalAlign="Center" Width="100px" />
                          </asp:BoundField>
                     
                             <asp:BoundField DataField="应付人" HeaderText="应付款人" >
                              <ItemStyle Width="100px" ForeColor="#595d5a" />
                                    <HeaderStyle HorizontalAlign="Center" Width="100px" />
                          </asp:BoundField>
