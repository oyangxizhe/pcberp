...
background-color :#f7f7f7;
 font-weight :bold;
 cursor:pointer;
  border-top :1px solid #ccc; border-bottom :1px solid #dddddd;  border-left:1px solid #dddddd; border-right:1px solid #dddddd;
   outline:none;
  margin-left:1%;
  ...
  <div class="c13110507" id ="Div3">
    ...
    <div class ="c21062701">
       <div class="c14031301" id ="Div11">
          ...
          <div id="i19030501" onmouseover="over(this,'edit_div')" onmouseout="out(this,'edit_div')"   
                         class ="c19020803" onclick ="sure()">确定</div></div>
     ...
     <div class="c14111903" id ="Div28">
            <input id="Text5" type="text"  runat ="server" class="c14111902" /></div>
                            <div class="c13110104" id ="Div29">
                                ...
                                ：</div>
     <div class="c14111903" id ="Div30">
     <input id="Text6" type="text"  runat ="server" class="c14111902" />
                ...
                <ItemTemplate >
                 ...
                 <ItemStyle Width="4%"  ForeColor="#595d5a"/>
                          ...
                          <asp:BoundField DataField="CNAME" HeaderText="客户名称" >
                             ...
                             <asp:BoundField DataField="订单状态" HeaderText="状态" >
                              <ItemStyle Width="4%" ForeColor="#595d5a" />
...
<script type="text/javascript" language="javascript">
    function selectall(obj) {
        ...
        for (i = 1; i <= tr.length - 1; i++) {
            ...
            v1.checked = obj.checked;
                table.rows(i).cells(0).checked = obj.checked;
            }
        }
    ...
    function f13100302(obj, obj1, obj2, obj3, obj4) {
        ...
        if (navigator.userAgent.indexOf("Chrome") > 0) {
            ...
            if (document.getElementById("come").value == "se") {
                window.opener.document.getElementById("Text2").value =obj+ "-" + obj1;
