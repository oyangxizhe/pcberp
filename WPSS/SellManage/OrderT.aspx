...
<input id="Submit1" type="submit" value="添加订单"  runat ="server"  onmouseover="over(this,'Submit2s')"
 ...
 <input id="Submit3" type="submit" value="退出"  runat ="server"  onmouseover="over(this,'Submit2s')"
              ...
              <div class="c13110510" id ="Div36">
   
       </div>
          
         <div class="c13110507" id ="Div42">
 <input id="Submit4" type="submit" value="打印"  runat ="server"  onmouseover="over(this,'Submit2s')"
             ...
             <div class="c13110510" id ="Div43">
   
       </div>
          
         <div class="c13110507" id ="Div44">
 <input id="Submit5" type="submit" value="确认对帐"  runat ="server"  onmouseover="over(this,'Submit2s')"
               onmouseout="out(this,'Submit2s')" class ="c19012703"  
              onserverclick="submit1_Click" />
   </div>
 ...
 <input id="Submit6" type="submit" value="对帐还原"  runat ="server"  onmouseover="over(this,'Submit2s')"
               onmouseout="out(this,'Submit2s')" class ="c19012703"  
              onserverclick="submit1_Click" />
   </div>
  ...
  <div class="c13101903" id ="Div38">
   ...
   <input id="Text11" type="text"  runat ="server"  class ="c13102103"  /></div>
         ...
         <div class="c13101903" id ="Div15">
             客户订单号<asp:GridView ID="GridView5" runat="server">
             </asp:GridView>
               </div>
        ...
        <asp:GridView ID="GridView2" runat="server" 
          ...
          <asp:BoundField DataField="品号" HeaderText="ID" >
            ...
            <asp:BoundField DataField="品名" HeaderText="品名" >
                           ...
                           <asp:BoundField DataField="铜厚" HeaderText="铜厚" >
                              <ItemStyle Width="120px"  ForeColor="#595d5a"/>
                                    <HeaderStyle Width="120px" HorizontalAlign="Center" />
                          </asp:BoundField>
                         ...
                         var table = document.getElementById('<%=GridView1.ClientID%>');
                          ...
                          for (i = 1; i < tr.length; i++) {
                              if (obj1 == i) {
                                  ...
                                  tr[i].getElementsByTagName("td")[12].getElementsByTagName("input")[0].value = dlgResult[15];
                                  tr[i].getElementsByTagName("td")[13].getElementsByTagName("input")[0].value = dlgResult[6];
                                  break;

                                  /*dlgResult[0] Wareid,dlgResult[1] CO_WAREID,dlgResult[2] WNAME,dlgResult[3] CWAREID,dlgResult[4] CNAME,*/
                                  /*dlgResult[5] SELLUNITPRICE,dlgResult[6] SPEC,dlgResult[7] REMARK dlgResult[15] PLANK_THICKNESS*/
                              }
                          }
