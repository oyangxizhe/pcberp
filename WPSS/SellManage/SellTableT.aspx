...
<body >
   ...
   <input id="jemid" type="hidden"  runat="server" />
...
<input id="Submit1" type="submit" value="添加销货单"  runat ="server"  onmouseover="over(this,'Submit2s')"
...
<input id="Text1" type="text"  runat="server"   class ="c13110901"    />  
  ...
  <div class="c13101903" id ="Div38">
   ...
   <input id="Text10" type="text"  runat ="server"  class ="c13102103"  /></div>
     ...
     <div class="c13111503" id ="Div37" visble="false">
         &nbsp;<span style =" margin-left :2px; margin-right :2px;"></span>
   </div>

  <div class="c13101903" id ="Div42" visble="false">
                          &nbsp;&nbsp;&nbsp;
                          </div>
...
<div id="i13111001" class ="c13102201">
           <asp:GridView ID="GridView1" runat="server" 
               ...
               <HeaderStyle Width="2%" />
                ...
                <ItemTemplate >
                                <asp:TextBox ID="TextBox21" runat="server"  Text='<%#Eval ("订单号") %>' CssClass="c14071609" ></asp:TextBox>   
           ...
           <asp:TemplateField HeaderText="ID" >
               ...
               <asp:TemplateField HeaderText="未销货数量">
                ...
                <ItemTemplate >
                 ...
                 <ItemStyle Width="5%"  ForeColor="#595d5a"/>
                                 ...
                                 <asp:TemplateField HeaderText="累计销退数量"   >
                <ItemTemplate >
                 <asp:TextBox ID="TextBox101" runat="server" Text='<%#Eval ("累计销退数量") %>'  CssClass ="c14071615"></asp:TextBox>                     
                </ItemTemplate>
                    <HeaderStyle Width="5%" />
                 <ItemStyle Width="5%"  ForeColor="#595d5a"/>
            </asp:TemplateField> 
              ...
              <HeaderStyle Width="4%" />
               ...
               <asp:TemplateField HeaderText="Free数量">
                ...
                <ItemTemplate >
                 <asp:TextBox ID="TextBox19" runat="server" Text='<%#Eval ("板厚") %>'  CssClass="c14071609"></asp:TextBox>                     
                </ItemTemplate>
             <HeaderStyle Width="5%" />
                 <ItemStyle Width="5%"  ForeColor="#595d5a" />
            </asp:TemplateField> 
   ...
   <input id="Text9" type="text"  runat ="server" class ="c13102908"  /> 
       ...
       <script type ="text/javascript" >
               ...
               if (obj == "Text2") {
                   ...
                   if (navigator.userAgent.indexOf("Chrome") > 0) {
                       ...
                       for (i = 1; i < tr.length; i++) {
                           if (obj1 == i) {
                               var v5 = tr[i].getElementsByTagName("td")[10].getElementsByTagName("input")[0];
                               var v6 = tr[i].getElementsByTagName("td")[11].getElementsByTagName("input")[0];
          ...
          document.onkeydown = enter2tab;
           ...
           function f2() {
               var url = "/print/rviewer.aspx?come=selltable&id=" + document.getElementById('<%=Text1.ClientID%>').value;
