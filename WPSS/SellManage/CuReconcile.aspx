...
<input id="Submit1" type="submit" value="添加客户对账单"  runat ="server"  onmouseover="over(this)"
         ...
         <a href ="javascript:f13100302('<%#Eval ("对账单号") %>');">选取</a>
              ...
              <asp:TemplateField HeaderText="对账单号">
                <ItemTemplate >
                    ...
                    <a href ="CuReconcileT.aspx?crid=<%#Eval ("对账单号") %>&aore=1" target="_search"><%#Eval ("对账单号") %></a>
