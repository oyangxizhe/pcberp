...
<script type="text/javascript" language="javascript">
    function f13100302(obj, obj1, obj2, obj3) {
        ...
        if (navigator.userAgent.indexOf("Chrome") > 0) {
            ...
            window.opener.document.getElementById("CUKEY").value = obj;
            window.opener.document.getElementById("Text6").value = obj1;
            window.opener.document.getElementById("Text10").value = obj2;
            window.opener.document.getElementById("Text11").value = obj3;
